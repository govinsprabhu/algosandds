...

{
     ...
     * @param labeling Labelling algorithms.problems.crakingthecoding.array
    ...
    /**
     * Calculate the number of nodes from the edges algorithms.problems.crakingthecoding.array
     * @param edges The edges algorithms.problems.crakingthecoding.array
     ...
     */
    private static void loadGraphFromFile() throws IOException {
